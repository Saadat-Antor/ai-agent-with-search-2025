...
graph.add_node("retrieve_reddit_posts", retrieve_reddit_posts)
...
graph.add_node("analyze_reddit_posts", analyze_reddit_posts)
...
graph.add_edge("analyze_google_results", "synthesize_analyses")
graph.add_edge("analyze_bing_results", "synthesize_analyses")
graph.add_edge("analyze_reddit_results", "synthesize_analyses")
